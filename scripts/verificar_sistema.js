...
function main() {
  ...
  ok("Califica para visita persiste en Render", contains(app, "guardarCalificacionDesmarque") && contains(app, "actualizarSolicitudEnDb(sol.id, { documentos, calificacion_desmarque: valor })") && contains(app, "syncPersona({ estado_desmarque: nuevoEstado })"));
